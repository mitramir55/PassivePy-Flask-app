...
def analyze_dataset(mode, file, column_name):
    ...
    if file and allowed_file(file.filename):
        ...
        if mode=='corpus_level':
            df_output = passivepy.match_corpus_level(df=df, column_name = column_name, n_process = 1, batch_size = 70)
        elif mode=='sentence_level':
            df_output = passivepy.match_sentence_level(df=df, column_name = column_name, n_process = 1, batch_size = 70)
